...
public class SmileDemoEDA {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SmileDemoEDA sd_test = new SmileDemoEDA ();
        PassengerProvider2 pProvider_test = new PassengerProvider2 ();
        DataFrame testData = pProvider_test.readCSV (sd_test.testPath);
